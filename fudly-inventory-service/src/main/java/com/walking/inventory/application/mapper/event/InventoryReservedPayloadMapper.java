...
import com.walking.inventory.application.event.InventoryReservedPayload;
...
public interface InventoryReservedPayloadMapper {
    ...
    InventoryReservedPayload toPayload(Inventory inventory, Reservation reservation);
}
