...
import com.walking.inventory.application.event.InventoryExpiredPayload;
...
public interface InventoryExpiredPayloadMapper {
    ...
    InventoryExpiredPayload toPayload(Inventory inventory, Reservation reservation);
}
